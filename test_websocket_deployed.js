...
/**
 * WebSocket Connection Test for Deployed Backend
 * Tests WebSocket connections to snapify.skytech.mk
 */

import { io } from 'socket.io-client';

const WEBSOCKET_URL = 'wss://snapify.skytech.mk';
const TEST_DURATION = 30000; // 30 seconds
const PING_INTERVAL = 5000; // 5 seconds

console.log('🧪 Starting WebSocket Connection Test for Deployed Backend...');
