...
interface LandingPageProps {
  onGoogleLogin: () => void; // Changed signature: No longer takes role, simply triggers GSI
                ...
                if (googleButtonRef.current) {
                    googleButtonRef.current.innerHTML = `
                        <button 
                            ...
                            class="w-full h-full bg-white text-gray-700 border border-gray-300 rounded-lg font-medium px-4 py-2 flex items-center justify-center hover:bg-gray-50 transition-colors"
                        >
