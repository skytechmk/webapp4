...
type Tab = 'users' | 'events' | 'userEvents' | 'support' | 'settings' | 'system';
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 border-b border-slate-100 cursor-pointer hover:bg-slate-50 transition-colors ${
                        selectedUserId === conv.userId ? 'bg-indigo-50 border-l-4 border-l-indigo-500' : ''
                      }`}
                    >
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`text-xs mt-1 ${
                          message.isFromAdmin ? 'text-indigo-200' : 'text-slate-500'
                        }`}>
